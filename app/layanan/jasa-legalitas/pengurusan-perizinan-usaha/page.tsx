...
const perizinanMikro = [
  {
    ...
    price: "Rp. 500.000",
    features: ["NPWP Perorangan", "NPWP Perusahaan"],
  },
  {
    title: "OSS (Online Single Submission)",
    image: "/images/jasa-legalitas/pengurusan-perizinan-usaha/oss.png",
    price: "Rp. 500.000",
    features: ["NIB (Nomor Induk Berusaha)", "IUP (Izin Usaha Perdagangan)", "Izin Lokasi"],
  },
];
...
export default function PengurusanPerizinanUsahaPage() {
  return (
    <>
      <section className="w-full pt-4 md:pt-8 bg-gradient-to-t from-[#83A46D]/10 to-white">
      ...
      <section className="w-full pb-8 md:pt-8 md:pb-16 lg:pb-24 bg-gradient-to-b from-[#83A46D]/10 to-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:flex lg:flex-wrap lg:justify-center">
