...
const facilities = [
  {
    icon: <FiMail className="text-[#83A46D] w-6 h-6" />,
  ...
  {
    icon: <FiPhone className="text-[#83A46D] w-6 h-6" />,
...
export default function PerjanjianPage() {
  return (
    <>
      <section className="w-full pt-4 pb-8 md:pt-24 md:pb-16 bg-gradient-to-t from-[#83A46D]/10 to-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div
              ...
              className="flex-1"
            >
              <h2 className="text-3xl font-bold text-[#83A46D]">Virtual Office</h2>
              ...
              <p className="text-2xl font-bold text-[#83A46D]">Rp. 3.500.000</p>
              <button
                onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {facilities.map((facility, idx) => (
                <motion.div
                  ...
                  className="border-2 border-[#83A46D] rounded-lg p-6 bg-white"
                >
