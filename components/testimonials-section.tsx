...
const testimonials = [
  {
    ...
    content:
      "Berkat Nusantara Maju Luhur, saya bisa jadi CTO tanpa perlu ngoding. Cukup pakai ChatGPT dan template dari sini, semua developer saya kira saya jenius!",
    stars: 5,
  },
  {
    name: "Siti Rahayu",
    ...
    image: "/placeholder.svg?height=80&width=80",
    content:
      "Dulu saya bingung kalau ditanya soal coding. Sekarang saya punya jawaban template untuk semua pertanyaan teknis. Terima kasih Nusantara Maju Luhur!",
    stars: 5,
  },
  {
    name: "Dewi Lestari",
    ...
    image: "/placeholder.svg?height=80&width=80",
    content:
      "Followers Instagram saya naik drastis setelah saya pura-pura jadi programmer wanita. Padahal saya cuma pakai template dari Nusantara Maju Luhur!",
    stars: 5,
  },
  {
    name: "Agus Pratama",
      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold">
            Testimoni <span className="gradient-text">Alumni Nusantara Maju Luhur</span> yang Sukses
          </h2>
