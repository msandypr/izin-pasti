...
export default function Breadcrumb({ title, items }: BreadcrumbProps) {
    return (
      <section className="relative h-48 flex items-center justify-center bg-gradient-to-r from-[#2CBCC4] to-[#2CBCC4]/50 bg-cover bg-center">
        <div className="absolute inset-0 bg-gradient-to-r from-[#2CBCC4] to-[#2CBCC4]/50" />
